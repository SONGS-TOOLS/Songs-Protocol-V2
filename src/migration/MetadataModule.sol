...
contract MetadataModule is Ownable {
  ...
  // Add this function to get metadata
  ...
  // Add this function to remove metadata (only callable by authorized contracts)
  function removeMetadata(address wrappedSong) external {
    require(
      ...
      "Only protocol or authorized contracts can remove metadata"
    );
