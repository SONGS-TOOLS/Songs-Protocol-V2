  ...
  ReentrancyGuard
{
 ...
 M  * @dev Indicates whether a contract implements the `IERC1155Receiver` interface.
   ...
   */
  function migrateWrappedSong(address metadataAddress, address newWrappedSongAddress) external onlyOwner {
    // Verify caller is authorized at protocol level
    require(protocolModule.isAuthorizedContract(msg.sender), "Not authorized contract");
